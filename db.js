(function () {
    ...
    // Паддинги оранжевого бокса = паддинги блока оценки IMDb (масштабируемые)
    ...
    function showRating(rating, votes) {
        ...
        if (votes !== 'N/A') {
            ...
            var votesBox = $('<div></div>')
                ...
                .text(votes)
                .css({
                    'background': '#c2410c', // оранжевый
                    'color': '#fff',
                    'font-weight': 'bold',
                    'margin-right': '0.5em',

                    // ТОЧНО копируем паддинги с блока оценки
                    ...
                    // Копируем скругление и другие стили
