(function () {
    ...
    // Плагин: Чистый IMDb рейтинг + блок с голосами размером как возрастная категория
    ...
    function showRating(rating, votes) {
        ...
        // Добавляем блок с голосами размером как возрастная категория
        ...
        if (ageBlock.length && votes !== 'N/A') {
            ageBlock.before(
                ...
                'color: #fff !important;' +
                'font-size: 12px !important;' +          // такой же шрифт как в возрастном блоке
                ...
                'min-height: 24px !important;' +         // высота как у возрастного блока
