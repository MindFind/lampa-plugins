(function () {
    ...
    // Плагин: Чистый IMDb рейтинг + блок голосов идентичный возрастной категории (чёрный фон)
    ...
    function showRating(rating, votes) {
        ...
        // Блок голосов — точная копия стиля возрастного блока, только чёрный фон
        ...
        if (ageBlock.length && votes !== 'N/A') {
            ageBlock.before(
                ...
                'min-height: 28px !important;' +             // высота как у 13+/17+
